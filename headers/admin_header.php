    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse dual-nav w-50 order-1 order-md-0">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="manutencoes.php">Manutenções</a> <!-- acrescentar relatorios no toogle -->
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Arquivo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Gestão de condomínios e utilizadores</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Gestão de Condomínios</a>
                </li>
            </ul>
        </div>
