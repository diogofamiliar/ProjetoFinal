...
function OnButtonManu(){
  var x = $('[name="id_incidente[]"]:checked').length;
            if(x>0){ 
            var confirmed = confirm("Pretende agendar reparações para os incidentes selecionados?");
                if(confirmed){
...
function OnButtonEdit(){
  var x = $('[name="id_incidente[]"]:checked').length;
            ...
            swal("Selecione as checkboxs!", 
            "Selecione os incidentes que pretende editar!", 
            "error");
            return true;
            }
}
...
<div class="container col-11">
  <?php include "../../../assets/breadcrumbers/bc_incidentes.php" ?>
  <div class="w-100">
      <div class="card">
          <div class="card-header">
              <div class="w-100 d-flex justify-content-between">
                  <div>
                      <a class="btn btn-primary m-1" href="javascript:{}" onclick="return OnButtonManu();" style="min-width:60px;">Inserir manutenção</a>
                      <a class="btn btn-primary m-1" href="javascript:{}" onclick="return OnButtonLista();" style="min-width:60px;">Criar lista de tarefas</a>
                  </div>
                  <div>
                      <a href="registo_incidente.php" class="btn btn-success m-1" id="myButton" type="button" name="answer" style="min-width:60px;"><i class="fa fa-plus-square"></i> Registar incidente</a>
                      <a class="btn btn-danger m-1" href="javascript:{}" onclick="return checkDelete();" style="min-width:60px;"><i class="fa fa-trash"></i> Eliminar Incidente</a>
                      <a class="btn btn-primary m-1" href="javascript:{}" onclick="return OnButtonEdit();" style="min-width:60px;"><i class="fa fa-pencil"></i> Editar Incidente </a>
                  </div>
              </div>  
          </div>
        <div class="card-body">
  ...
  $(document).ready( function () {
    ...
    $('#data').DataTable({
      "columnDefs": [
        ...
        { "width": "15%", "targets": 2 },   //Condominio
        { "width": "20%", "targets": 3 },   //Local
        { "width": "25%", "targets": 4 },   //Descricao
        { "width": "15%", "targets": 5 },   //Avaria
        { "width": "10%", "targets": 6 }    //Fotografia
      ],
